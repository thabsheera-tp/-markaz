...
export default function TemporaryCommitteeSection({ committee = [] }) {
  ...
  return (
    <section id="leadership" className="w-full max-w-full overflow-hidden py-12 sm:py-20 lg:py-24 bg-[#f8fafc] border-b border-slate-200">
            ...
            >
              ...
              <div className="p-4 sm:p-6 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-slate-600 text-xs sm:text-sm font-light leading-relaxed mt-2.5 sm:mt-3 line-clamp-3">
                    {member.bio}
                  </p>
                </div>

                <div className="mt-4 sm:mt-5 pt-3.5 sm:pt-4 border-t border-slate-100 flex items-center justify-between text-xs">
                  {member.phone ? (
                    <a
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-[#004B87] hover:underline py-1 px-2 min-h-[36px]"
                  >
                    View Bio &rarr;
                  </button>
                </div>
