...
export default function CampusLocationSection({ footerData }) {
  ...
  return (
    <section id="location" className="py-16 bg-white relative border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-markaz-blue tracking-tight">
            Find Us at Koyyam, Kannur
          </h2>
          <p className="mt-2 text-sm sm:text-base text-slate-600 font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-start gap-3.5">
                <div className="w-10 h-10 rounded-2xl bg-markaz-blue text-white flex items-center justify-center shrink-0 shadow-md">
                  <Building className="w-5 h-5 text-emerald-400" />
                </div>
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400">Headquarters Address</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <a
                href={telLink}
                className="flex items-center gap-3 bg-white p-4 rounded-2xl border border-slate-200 hover:border-markaz-green shadow-sm hover:shadow-md transition-all group"
                title="Click to call directly"
              >
                <div className="w-10 h-10 rounded-xl bg-emerald-50 text-markaz-green flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 bg-white p-4 rounded-2xl border border-slate-200 hover:border-emerald-500 shadow-sm hover:shadow-md transition-all group"
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex items-center justify-center gap-2 bg-markaz-blue hover:bg-markaz-blue-light text-white font-bold py-3.5 rounded-2xl text-xs shadow-md shadow-markaz-blue/20 transition-all hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center p-3.5 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors"
          ...
          <div className="lg:col-span-7 h-[360px] lg:h-auto rounded-3xl overflow-hidden shadow-lg border border-slate-200 relative bg-slate-100">
            <iframe
            ...
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-md border border-slate-200/80 flex items-center gap-2 pointer-events-none">
